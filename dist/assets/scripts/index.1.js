...
function header() {
  ...
  headerAddressClose.addEventListener('mouseover', function () {
    closeAddressBlock();
  ...
  var visibleBurgerBtn = document.querySelector('.header__btn.burger');
  ...
  headerBurgerClose.addEventListener('mouseover', function () {
    closeBurgerBlock();
    alwaysVisibleBtnsHide();
  });
}
